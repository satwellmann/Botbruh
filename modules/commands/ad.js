...
"https://4.bp.blogspot.com/-yAExPAr7JeA/WDaBRVuJwxI/AAAAAAALb7I/Dbvda0KD5uECF3_SBjsvkl2_mqP9_BweQCLcB/s1600/AS000834_17.gif",
  ...
  💘 Mối quan hệ: Quan hệ cc
  😎 Quê quán: Hà Nội
  🤔 Nơi ở: Hà Nội
  ♓ Cung: Cự Giải
  👫 Gu: Dick bự :)))
  🌸 Tính cách: Là một con người với niềm đam mê thử thách bản thân và muốn vượt qua giới hạn bản thân để đạt được mục tiêu của mình <3 (Mõm)
...
----DCM----`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
